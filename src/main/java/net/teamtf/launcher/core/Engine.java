...
import net.teamtf.launcher.provider.AssestsProvider;
import net.teamtf.launcher.provider.LibraryProvider;
import net.teamtf.launcher.provider.NativeProvider;
